...
For example, the following line of code installs the [ggplot2](https://www.r-graph-gallery.com/ggplot2-package.html) package, which provides powerfull visualization tools. 
