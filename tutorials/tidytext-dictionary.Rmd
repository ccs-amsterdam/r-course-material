---
title: "Dictionaries with Tidy Text"
...
For example, let's see which emotional terms occur in te state of the union speeches:
...
Since both the `nrc` and `sotu_tokens` data frames contain the word column, 
