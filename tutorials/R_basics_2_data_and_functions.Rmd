...
Each parts has an excercise (not to be handed in), that you can find and complete in the separate **R_basics_2_data_and_functions_practise.Rmd** file on Canvas. You need to open this file in RStudio. We recommend first reading through the entire tutorial and then completing the exercise.
