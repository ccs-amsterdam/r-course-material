...
More interesting, however, is to e.g. select only the verbs:
Note that here I skip the corpus steps to show how you can also work directly with the texts and tokens:
