...
-   [The quanteda package](#the-quanteda-package)
    -   [Importing text and creating a quanteda corpus](#importing-text-and-creating-a-quanteda-corpus)
    -   [Creating the DTM (or DFM)](#creating-the-dtm-or-dfm)
    ...
    -   [Analysis](#analysis)
        ...
        -   [Scrabble word value](#scrabble-word-value)

This tutorial
=============

In this tutorial you will learn how to perform text analysis using the quanteda package. In the [R Basics: getting started](R_basics_1_getting_started.md) tutorial you were already given code to create wordclouds, compare term frequenties in two corpora and create keyword-in-context listings. This time, the goal is to understand this code better, towards becoming more self-proficient in using quanteda.
