...
See also chapter 14 of [R for Data Science](http://r4ds.had.co.nz/) and the [stringr cheat sheet](https://www.rstudio.com/resources/cheatsheets/#stringr)
...
Sometimes, you get unexpected results when you apply a text-based function to a factor. 
For example, normally `as.numeric` can be used to convert strings to numbers, setting non-numeric strings to NA:
...
For this purpose, R (like most other languages) use *regular expressions*, a very powerful wat to write
