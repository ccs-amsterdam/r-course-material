...
This document contains a tutorial, and there is an excercise that you can find and complete in the separate **R\_basics\_3\_functions\_practise.Rmd** file. You need to open this file in RStudio.
