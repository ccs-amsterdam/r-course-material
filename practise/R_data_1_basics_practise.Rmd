...
For this week's assignment (see separate tutorial on Canvas) you will be using RMarkdown. The file that you are currently reading is an RMarkdown file (.Rmd). This is type of file that combines two things:
...
You can do many things with RMarkdown, but for this assignment we'll stick to the basics. Below you will find templates for completing your assignments. For each assignment, you will have to enter your code in the designated code blocks. Eventually, you will *Knit* your file to a .html or .doc file and hand it in on Canvas. We'll start with an example.
...
* Find the setosa flowers with a sepal length of at most 4.4, and rename them to "sad setosa"
...
# tip: changing factors can be difficult, remember that changing them to character-vectors using "as.character()" is an easy way out
```
